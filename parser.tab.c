...
{
       0,    27,    27,    31,    32,    36,    37,    41,    50,    64,
      70,    76,    83,    89,    95,   103,   108,   114,   121,   129,
     138
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "ID", "NUMBER",
  "ASSIGN", "PLUS", "MINUS", "TIMES", "DIVIDE", "LPAREN", "RPAREN",
  "SEMICOLON", "INVALID", "$accept", "program", "statement_list",
  "statement", "declaration", "assignment", "expression", "term", "unary",
  "factor", YY_NULLPTR
};
...
{
     -15,     4,    14,   -15,    11,    17,   -15,   -15,   -15,    12,
      -2,   -15,   -15,   -15,    -2,    -2,    -2,     3,    10,   -15,
     -15,   -15,   -15,     0,    -2,    -2,   -15,    -2,    -2,   -15,
      10,    10,   -15,   -15
};
...
{
       4,     0,     2,     1,     0,     0,     3,     5,     6,     0,
       0,     7,    18,    19,     0,     0,     0,     0,    11,    14,
      17,    15,    16,     0,     0,     0,     8,     0,     0,    20,
       9,    10,    12,    13
};
...
{
     -15,   -15,   -15,   -15,   -15,   -15,     8,    -3,   -14,   -15
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     2,     6,     7,     8,    17,    18,    19,    20
};
...
{
      21,    22,    12,    13,     3,    14,    15,    24,    25,    16,
      24,    25,    29,    32,    33,     9,    26,     4,     5,    27,
      28,    30,    31,    10,    23,    11
};

static const yytype_int8 yycheck[] =
{
      14,    15,     4,     5,     0,     7,     8,     7,     8,    11,
       7,     8,    12,    27,    28,     4,    13,     3,     4,     9,
      10,    24,    25,     6,    16,    13
};
...
{
       0,    16,    17,     0,     3,     4,    18,    19,    20,     4,
       6,    13,     4,     5,     7,     8,    11,    21,    22,    23,
      24,    23,    23,    21,     7,     8,    13,     9,    10,    12,
      22,    22,    23,    23
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* declaration: INT ID SEMICOLON  */
#line 42 "parser.y"
      {
          if (declareVariable((yyvsp[-1].str)))
...
#line 1104 "parser.tab.c"
  ...
  case 8: /* assignment: ID ASSIGN expression SEMICOLON  */
#line 51 "parser.y"
      {
          if (!isDeclared((yyvsp[-3].str))) {
              fprintf(stderr, "Semantic Error: variable '%s' used before declaration.\n", (yyvsp[-3].str));
              setSemanticError();
          } else if ((yyvsp[-1].str) != NULL) {
              generateAssignment((yyvsp[-3].str), (yyvsp[-1].str));
          }
          free((yyvsp[-3].str));
          free((yyvsp[-1].str));
      }
...
#line 65 "parser.y"
      {
          (yyval.str) = generateTAC((yyvsp[-2].str), "+", (yyvsp[0].str));
          free((yyvsp[-2].str));
          free((yyvsp[0].str));
      }
...
#line 1157 "parser.tab.c"
  ...
  case 13: /* term: term DIVIDE unary  */
#line 90 "parser.y"
      {
          (yyval.str) = generateTAC((yyvsp[-2].str), "/", (yyvsp[0].str));
          free((yyvsp[-2].str));
...
#line 1184 "parser.tab.c"
  ...
  case 16: /* unary: MINUS unary  */
#line 109 "parser.y"
      {
          /* Unary minus is represented as 0 - operand. */
          (yyval.str) = generateTAC("0", "-", (yyvsp[0].str));
          free((yyvsp[0].str));
      }
#line 1194 "parser.tab.c"
    break;

  case 17: /* unary: factor  */
#line 115 "parser.y"
      {
          (yyval.str) = (yyvsp[0].str);
      }
...
#line 130 "parser.y"
      {
          ...
          snprintf((yyval.str), 32, "%d", (yyvsp[0].num));
      }
